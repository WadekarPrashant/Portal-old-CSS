...
export const PlatformVkColorNegative = ({ className }) => {
  return (
    <svg
      className={`platform-vk-color-negative ${className}`}
      fill="none"
      height="48"
      viewBox="0 0 48 48"
      width="48"
    ...
    >
      <g className="g" clipPath="url(#clip0_27_123)">
        <path
          className="path"
          clipRule="evenodd"
      ...
      <defs className="defs">
        <clipPath className="clip-path" id="clip0_27_123">
